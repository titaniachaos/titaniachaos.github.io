...
Erzeuge zwanzig kurze körperliche Improvisationen von jeweils ungefähr einer Minute. Verwende in der ersten Runde keine Objekte. Jede Improvisation erhält eine genaue Bedingung…

`Deutsch` `Clown Project` `Solitude` `Studio Practice`

[Artikel lesen →](./twenty-solitudes)

---

## [Beobachtungspraxis](./observation-practice)

Beobachte alleiniges Verhalten, ohne Motive zuzuschreiben. Notiere nur Sicht- oder Hörbares: Handlungen, Wiederholungen, Pausen, kleine Rituale, Raumnutzung, Beziehungen zu…

`Deutsch` `Clown Project` `Solitude` `Studio Practice`

[Artikel lesen →](./observation-practice)

---

## [Den Flop lesen](./reading-the-flop)

Scheitern wird beobachtet, nachdem es geschieht, statt nach einer Skala hergestellt zu werden. Frage: Was wollte Titania? Was scheiterte? Konnte das Publikum ihr Ziel erkennen?…

`Deutsch` `Clown Project` `Audience` `Failure`

[Artikel lesen →](./reading-the-flop)

---

## [D. W. Winnicott — die Fähigkeit zum Alleinsein](./winnicott-the-capacity-to-be-alone)

Status: Verifiziert Quellenbefund: Winnicott beschreibt die Fähigkeit zum Alleinsein durch das Paradox, in Anwesenheit eines verlässlichen, nicht fordernden anderen allein zu…

`Deutsch` `Clown Project` `Solitude` `Audience`

[Artikel lesen →](./winnicott-the-capacity-to-be-alone)

---

## [Henri Bergson — komische Unbewusstheit](./bergson-comic-unconsciousness)

Status: Verifiziert Quellenbefund: Bergson verbindet komische Wirkung mit dem begrenzten Bewusstsein einer Figur für das, was andere sehen. Für dieses Projekt: Das lässt sich mit…

`Deutsch` `Clown Project` `Clowning` `Studio Practice`

[Artikel lesen →](./bergson-comic-unconsciousness)

---

## [Philippe Gaulier — Complicité](./gaulier-complicite)

Status: Gewählte Linie Quellenbefund: Gaulier verwendet complicité für ein spontanes, oft unausgesprochenes Verständnis zwischen Spielenden und mit einem Publikum. Für dieses…

`Deutsch` `Clown Project` `Solo Titania Chaos` `Audience`

[Artikel lesen →](./gaulier-complicite)
