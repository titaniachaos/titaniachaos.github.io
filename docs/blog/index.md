...
Generate twenty short physical improvisations, approximately one minute each. In the first round, use no objects. Each improvisation receives one precise condition or task. The…

`English` `Clown Project` `Solitude` `Audience`

[Read article →](./twenty-solitudes)

---

## [Observation Practice](./observation-practice)

Observe solitary behaviour without assigning motives. Record what can actually be seen or heard: actions, repetitions, pauses, small rituals, use of space, relationships with…

`English` `Clown Project` `Failure` `Object Play`

[Read article →](./observation-practice)

---

## [Reading the Flop](./reading-the-flop)

Failure is observed after it happens rather than manufactured according to a scale. Ask: - What did Titania want? - What failed? - Could the audience see what she wanted? - What…

`English` `Clown Project` `Audience` `Failure`

[Read article →](./reading-the-flop)

---

## [D. W. Winnicott — the capacity to be alone](./winnicott-the-capacity-to-be-alone)

Status: Verified Source finding: Winnicott describes the capacity to be alone through the paradox of being alone in the presence of a reliable, non-demanding other. For this…

`English` `Clown Project` `Solitude` `Audience`

[Read article →](./winnicott-the-capacity-to-be-alone)

---

## [Henri Bergson — comic unconsciousness](./bergson-comic-unconsciousness)

Status: Verified Source finding: Bergson connects comic effect with a character's limited awareness of what others can see. For this project: This can be compared with clown…

`English` `Clown Project` `Clowning` `Studio Practice`

[Read article →](./bergson-comic-unconsciousness)

---

## [Philippe Gaulier — complicité](./gaulier-complicite)

Status: Chosen lineage Source finding: Gaulier uses complicité for a spontaneous, often unspoken understanding between performers and with an audience. For this project: The…

`English` `Clown Project` `Solo Titania Chaos` `Audience`

[Read article →](./gaulier-complicite)
